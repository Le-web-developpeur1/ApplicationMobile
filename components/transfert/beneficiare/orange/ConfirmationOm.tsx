...
export default function ConfirmationOm() {
        ...
        const { phone, name, amount, fraisValue, tauxValue, montantFacturer, typeTransfert } = route.params as {
            phone: string,
            name: string,
            amount: string,
            fraisValue: Number,
        ...
        let titleBenef = typeTransfert === "sortant" ? "Déstinataire" : "Expéditaire"
        ...
        const montantFac = new Intl.NumberFormat("fr-FR").format(Number(montantFacturer));
                ...
                <ScrollView style={{ flex: 1 }}>
                        <View style={styles.amount}>
                            ...
                            <View style={styles.montantEnvoie}>
                                <Text style={styles.textEnvoie}>Montant d'envoi</Text>
                            </View>

                            <Text style={styles.amountBig}>{montantFac} GNF</Text>
                        </View>
                        <View style={styles.separator} />
                        <View style={styles.benef}>
                            <Text style={styles.benefTitle}>{titleBenef}</Text>
