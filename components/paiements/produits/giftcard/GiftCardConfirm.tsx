...
export default function GiftCardConfirm() {
    ...
    const { euro, gnf, euroValue, gnfValue, name, nom, email} = route.params as {
        euro: string,
        gnf: string,
        euroValue: string,
        gnfValue: string,
                            ...
                            >
                                    <View style={styles.amount}>
                                        ...
                                        <View style={styles.euro}>
                                            <Text style={styles.amountSmall}>{name} gift card</Text>
                                            <Text style={styles.amountBig}>{ euro ?? `${euroValue} €`}</Text>
                                        </View>
                                        ...
                                        <Text style={styles.amountBig}>{gnf ?? gnfValue} GNF</Text>
                                    </View>
