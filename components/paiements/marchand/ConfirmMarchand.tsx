...
export default function ConfirmMarchand() {
    ...
    const { amount, phone, name } = route.params as {
        amount: string;
        phone: string;
        name: string;
    };
    ...
    const animatedHeight = scrollY.interpolate({
        inputRange: [0, 50],
        outputRange: [verticalScale(240), verticalScale(100)],
        extrapolate: "clamp",
    });
                    ...
                    <Animated.View style={[styles.container2, { height: animatedHeight }]}>
                        ...
                        >
                                ...
                                <View style={styles.benef}>
                                    <Text style={styles.benefTitle}>Marchand</Text>
