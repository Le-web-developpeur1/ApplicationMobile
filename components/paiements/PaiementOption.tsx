...
const paiementService = [
    { label: "Produits digitaux", img: require("@/assets/images/paiement/produits.png"), route: "PaiementProduit" },
    { label: "Paiement d'électricité", img: require("@/assets/images/paiement/edg.jpeg"), route: "PaiementFacture"},
] as const;
